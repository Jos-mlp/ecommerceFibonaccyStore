...
<div class="container py-3 pb-5">
	...
	<div class="row row-cols-1 row-cols-sm-2 row-cols-md-6">
		...
		<div class="col text-center">
			...
			<h3 class="py-3 text-muted">Guatemala</h3>
		...
		<div class="col text-center">
			...
			<h3 class="py-3 text-muted">Quetzaltenango</h3>
		...
		<div class="col text-center">
			...
			<h3 class="py-3 text-muted">Peten</h3>
		...
		<div class="col text-center">
			...
			<h3 class="py-3 text-muted">Huehuetenango</h3>
		...
		<div class="col text-center">
			...
			<h3 class="py-3 text-muted">Zacapa</h3>
		...
		<div class="col text-center">
			...
			<h3 class="py-3 text-muted">Quiche</h3>
